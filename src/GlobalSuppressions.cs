...
[assembly: SuppressMessage("Info Code Smell", "S1133:Deprecated code should be removed", Justification = "Calm down it has just been added", Scope = "member", Target = "~M:CommandLinePlus.IConsoleProcessor.Run~CommandLinePlus.RunResult")]
